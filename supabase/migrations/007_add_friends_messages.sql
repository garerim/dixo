...
CREATE INDEX idx_friendships_user_id ON public.friendships(user_id, status);
CREATE INDEX idx_friendships_friend_id ON public.friendships(friend_id, status);
...
-- Index pour les requêtes fréquentes
CREATE INDEX idx_messages_sender ON public.private_messages(sender_id, created_at DESC);
CREATE INDEX idx_messages_receiver ON public.private_messages(receiver_id, is_read, created_at DESC);
CREATE INDEX idx_messages_conversation ON public.private_messages(
